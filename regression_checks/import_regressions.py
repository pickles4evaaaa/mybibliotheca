...
def run_regression_suite():
    ...
    results.append(
        (
            "map_goodreads_shelves",
            mappings.get("Bookshelves") == "custom_personal_goodreads_shelves",
        )
    )
    ...
    results.append(
        ("map_storygraph_status", mappings.get("Read Status") == "reading_status")
    )
    ...
    results.append(
        ("map_reading_history_book", mappings.get("Book Name") == "Book Name")
    )
    results.append(
        ("map_reading_history_pages", mappings.get("Pages Read") == "Pages Read")
    )
    results.append(
        ("map_reading_history_minutes", mappings.get("Minutes Read") == "Minutes Read")
    )

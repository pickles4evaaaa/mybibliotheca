...
from .book_route_helpers import (
    _normalize_personal_datetime,
    _datetimes_equal,
    _humanize_status,
    _normalize_reading_status,
    _dedupe_preserve_order,
    _parse_additional_categories,
    _category_name_from_record,
    _extract_existing_categories_from_book,
    _convert_published_date_to_date,
    _safe_date_to_isoformat,
    _format_published_date_for_input,
)
...
from .book_search_route import search_book_details as _search_book_details

@book_bp.route('/search_details', methods=['POST'])
def search_book_details():
    return _search_book_details()

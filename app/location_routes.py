...
def get_location_service():
    ...
    @contextmanager
    def _get_service():
        with safe_get_connection(user_id=current_user.id, operation="location_service") as connection:
            yield LocationService(connection)
...
def manage_locations():
    ...
    with get_location_service() as location_service:
